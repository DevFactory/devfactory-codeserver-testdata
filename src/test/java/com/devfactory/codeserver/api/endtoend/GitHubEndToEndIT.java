...
public class GitHubEndToEndIT extends BaseIntegrationTest {
    ...
    public void test_110_createRepo() throws Exception {
        ...
        dto.setName("GitHub Project");
        dto.setScmUrl("https://github.com/rwanderc/tmp-longmethod.git?branch=master");
